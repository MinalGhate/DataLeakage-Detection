...
function generateCard(row) {
  ...
  div_card.style = 'width: 100%; color: black;';
  ...
  div_card_body.appendChild(document.createElement('br'));
  div_card_body.appendChild(document.createElement('br'));
  // Create anchor element to wrap the link
  const link = document.createElement('a');
  link.href = row.leakyURL;
  link.textContent = row.leakyURL;
  // Apply white color to the link
  link.style.color = 'white';
  // Append the link to the card body
